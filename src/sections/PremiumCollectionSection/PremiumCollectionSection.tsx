                    ...
                    <CarouselItem key={item.id} className="w-full h-full">
                      <div className="flex h-full">
                        ...
                        <div className="flex-1 flex flex-col p-12 pt-[93px]">
                          <h3 className="font-outfit font-semibold text-white text-[40px] mb-10">
                            {item.title}
                          </h3>
                          <p className="opacity-70 font-outfit font-normal text-white text-xl whitespace-pre-line mb-10">
                            {item.description}
                          </p>
                          ...
                          <div className="flex justify-between items-center mt-auto">
                            <Button
                              variant="outline"
                              className="h-[41px] rounded-md border border-white bg-transparent hover:bg-white/10 text-white text-xl font-normal"
                            >
                              Buy Now
                            </Button>
                            ...
                            <div className="flex items-center">
                              ...
                              <span className="mx-4 font-outfit font-medium text-white text-xl">
                                01/04
                              </span>
